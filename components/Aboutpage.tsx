...
export default function Aboutpage({ abouts }: Props) {
    ...
    return (
        ...
        md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center mb-10 sm:mb-5 md:mb-[-100px]'>

                <h3 className='md:absolute lg:absolute xl:absolute top-24 uppercase tracking-[20px]
            text-gray-300 text-2xl'>About</h3>

                <h3 className='md:absolute lg:absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm'>
